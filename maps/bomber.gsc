...
fuel_crank_activate(num)
{
	...
	println("^3bomber_debug: level.use_crank setcursorhint");
	level.use_crank[i] setcursorhint("HINT_ACTIVATE");

	println("^3bomber_debug: level.use_crank sethintstring");
	level.use_crank[i] sethintstring(&"GMI_SCRIPT_HINTSTR_FUEL_WHEEL");

	println("^3bomber_debug: level.fuel_crank HIDEME");
	level.fuel_crank[i] thread hideme();

	println("^3bomber_debug: level.use_crank SHOWME");
	level.use_crank[i] thread showme();

	println("^3bomber_debug: fuel_flash SHOWME");
	level.fuel_flash[i] thread showme();

	println("^3bomber_debug: use_crank WAITTILL");
	level.use_crank[i] waittill ("trigger");
	println("^5bomber_debug: Crank used!");
...
lull1()
{
	level.spit[1] waittill("spits go home");

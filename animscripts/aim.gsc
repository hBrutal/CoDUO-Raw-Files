...
keep_aiming(minTime, maxTime)
{
	...
	{
		target = self.anim_aimOverridePos;
	}
	else if (isDefined(self.anim_enemyOverride))
	{
...
keepAimingAtTarget(targetPoint, minTime, maxTime)
{
	...
	/#[[anim.locSpam]]("a16");#/
 	...
 	{
//MikeD: Took out... Need to see level prints.
//println("!!! ASSUMING PRONE !!! (self.anim_pose = " + self.anim_pose + ")" );
		/#[[anim.locSpam]]("a22");#/

...
{
	/#[[anim.println]]("UpdateCombatEndTime called with \"",script1name,"\" and \"",script2name,"\".  Time: ",GetTime(),".");#/
	sn[0] = script1name;
...
sightCheckNode(invalidateNode)
{
    ...
    {
		/#[[anim.println]]("SightCheckNode failed one time too many.  Invalidating current cover node.");#/
